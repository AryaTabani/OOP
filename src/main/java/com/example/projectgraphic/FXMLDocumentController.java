...
public class FXMLDocumentController implements Initializable {
    ...
    private Alert alert;
    private final String[] questionList = new String[]{"What is your favorite Color?", "What is your favorite food?", "what is your birth date?"};
...
//    }
    ...
    public void regLquestionList() {
        ...
        su_question.getItems().add("Item 1");
        su_question.getItems().add("Item 2");
        su_question.getItems().add("Item 3");
